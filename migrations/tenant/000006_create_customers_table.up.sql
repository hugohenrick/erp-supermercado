...
CREATE INDEX IF NOT EXISTS idx_customers_price_table_id ON customers(price_table_id);
CREATE INDEX IF NOT EXISTS idx_customers_payment_method_id ON customers(payment_method_id); 